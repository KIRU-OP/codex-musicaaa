...
from codex.utils.decorators.admins import ActualAdminCB
from codex.utils.decorators.language import language, languageCB
from codex.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from codex.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("dil_codex") & ~BANNED_USERS)
@languageCB
